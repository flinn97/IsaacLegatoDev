...
class Dispatch extends Component {
    ...
    render() {
        ...
        let prepare = this.props.app.prepare;
        let run = this.props.app.run;
        let cleanPrepare=this.props.app.cleanPrepare;
        let cleanPrepareRun=this.props.app.cleanPrepareRun;
        let prepareRun=this.props.app.prepareRun;
        let factory= this.props.app.state.factory;
        let user= this.props.app.state.currentuser;
        let componentUpdate=this.props.app.state.componentUpdate;
        ...
        return (
            <div>
                ...
                {state.popupSwitch==="addStudent" && (<Addstudent  app={app}  handleClose={dispatch.bind(this, {popupSwitch:""})}/>)}
