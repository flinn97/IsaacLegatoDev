      ...
      let badgeList = comp?.getList("badge", studentJson._id);
        ...
        return (
            <div className="popup-box" style={{ zIndex: "1010" }}>
                <div ref={this.wrapperRef}  className="diapicboxa" style={{ zIndex: "1010", height:"54vh" }}>
            ...
            <div style={{display:"flex", justifyContent:"center", alignItems:"center"}}><img style={{}} src={progress} alt="starpoints" /> <div style={{color:styles.colors.color6, position:"absolute", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", marginRight:"3px"}}><div>{starpoints.getJson().level}</div><div>level</div></div></div>
               ...
               src={badge.getJson().picURL} style={{width:"3.7vw"}}/>)}
               </div>
